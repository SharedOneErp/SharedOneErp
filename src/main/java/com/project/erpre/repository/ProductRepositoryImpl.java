...
//    // 3. 특정 조건으로 상품 정렬
//    @Override
//    public Page<ProductDTO> sortProduct(int page, int size, String status, String sortColumn, String sortDirection) {
//
//        QProduct product = QProduct.product;
//        QCategory topCategory = new QCategory("topCategory");
//        QCategory middleCategory = new QCategory("middleCategory");
...
//                break;
//            default:
//                orderSpecifier = product.productCd.asc(); // 기본 정렬은 품번으로
//        }
//
//        // 정렬된 상품 목록 조회
...
//                .fetchCount();
//
//        return new PageImpl<>(products, PageRequest.of(page, size), totalItems);
//    }
