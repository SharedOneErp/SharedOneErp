                ...
                <div className="menu_content">
                    <div className="middle-container">
                        <form className='search-container'>
                            ...
                            <input type='text' className='box' placeholder='검색어를 입력하세요' />
                            <button type='submit' className='box color_border'>검색</button>
                        </form>
                        ...
                        <div className='select-category'>
                            ...
                            <div>
                                <label>품목명</label>
                                <input type='text' placeholder='검색어 입력' className='box' />
                                <button type='submit' className='box color_border'>검색</button>
                            </div>
                        </div>
                        ...
                        <div className='date-container'>
                            ...
                            <div className='date-form'>
                                <input type='date' className='box' value='2024-01-01' />
                                <p>~</p>
                                <input type='date' className='box' value='2024-12-31' />
                            </div>
                        </div>
                    </div>
