        ...
        <Layout currentMenu="ProductDetail">
            ...
            <div className="product-detail-container">
                ...
                <div className="form-group">
                    ...
                    <input type="text" id="registrationDate" value={formatDate(productDetail[0]?.productInsertDate)} readOnly />
                </div>
                <div className="form-group">
                    <label htmlFor="registrationDate">상품 수정일</label>
                    <input type="text" id="registrationDate" value={formatDate(productDetail[0]?.productUpdateDate)} readOnly />
                </div>
