            ...
            <td className="vat">
                <div className='period_box'>
                    <input
                        ...
                        onChange={() => clearErrors(['priceStartDate', 'priceEndDate'])} // 시작일 입력 시 오류 제거
                    />
                    ~
                    <input
                        type="date"
                        ...
                        onChange={() => clearErrors(['priceStartDate', 'priceEndDate'])} // 종료일 입력 시 오류 제거
                    />
                </div>
                {/* 시작일 또는 종료일 에러 메시지 하나만 표시 */}
